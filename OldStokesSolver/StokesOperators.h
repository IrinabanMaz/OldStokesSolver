...
private:
    ...
    StokesTractionHarmonic& operator =(const StokesTractionHarmonic& t) { return *this; }
    StokesTractionHarmonic& operator =(StokesTractionHarmonic&& t) noexcept { return *this; }
